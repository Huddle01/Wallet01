...
import { connectorName, connect, getAccount, resolveDid, disconnect } from "@huddle01-wallets/multichain";
...
const connectLoadable = loadable(atom(
    null,
    async ( _, set, { connector, _chainId }: { connector: connectorName, _chainId: string }) => {
